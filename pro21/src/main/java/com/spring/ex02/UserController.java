...
//	  return mav; }
	...
	public ModelAndView memberInfo(HttpServletRequest request, HttpServletResponse resposne) throws Exception {
		request.setCharacterEncoding("utf-8");
		ModelAndView mav = new ModelAndView();
	...
	private String getViewName(HttpServletRequest request) throws Exception {
		...
		// http://localhost:8080/member/listMember.do로 요청시 먼저 '.do'를 제거
