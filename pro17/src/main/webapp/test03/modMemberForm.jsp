...
<form method="post" action="${contextPath }/member/modMember.do?id=${memInfo.id}">
		<table align="center">
			...
			<tr>
				...
				<td width="400"><input type="date" name="joindate" value="${memInfo.joinDate }" disabled="disabled"></td>
			</tr>
			<tr>
				<td width="200">
				<p>&nbsp;</p>
				...
				<td width="400">
				<input type="submit" value="수정"><a href="${contextPath}/member/modMemberForm.do?id=${mem.id }">
